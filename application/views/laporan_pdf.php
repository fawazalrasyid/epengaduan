    ...
    <div class="container-fluid">
      ...
      <table class="table">
        <thead class="thead-dark">
          <tr>
            <th style="vertical-align:center" scope="col">No</th>
            <th style="vertical-align:center" scope="col">Nama</th>
            <th style="vertical-align:center" scope="col">Nik</th>
            <th style="vertical-align:center" scope="col">Laporan</th>
            <th style="vertical-align:center" scope="col">Tanggal Pelaporan</th>
            <th style="vertical-align:center" scope="col">Status</th>
            <th style="vertical-align:center" scope="col">Tanggapan</th>
            <th style="vertical-align:center" scope="col">Tanggal Tanggapan</th>
          </tr>
        </thead>
        <tbody>
          <?php $no = 1; ?>
